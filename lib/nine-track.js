      ...
      function createRemoteReq (connInfo, cb) {
        ...
        if (that.seriesKey) {
          ...
          // Otherwise, if this is not a new recording, consider our series corrupted
            ...
            return that.removeFixtures(nonPlaceholderRequestKeys, function handleRemoval (err) {
              // Prepare our message
